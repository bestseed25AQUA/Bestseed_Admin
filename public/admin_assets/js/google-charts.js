...
google.charts.load('current', {
  'packages': ['geochart'],
  // Reads window.MAPS_API_KEY, which Blade layouts should set from
  // config('services.google.maps_api_key'). See resources/views/layouts/*.blade.php
  // for the inline <script>window.MAPS_API_KEY = "{{ config('services.google.maps_api_key') }}"</script>
  // Falls back to an empty string so the file is safe to commit.
  'mapsApiKey': (typeof window !== 'undefined' && window.MAPS_API_KEY) ? window.MAPS_API_KEY : ''
});
